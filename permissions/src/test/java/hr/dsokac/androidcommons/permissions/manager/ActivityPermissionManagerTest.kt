...
import hr.dsokac.androidcommons.permissions.CAMERA_PERMISSIONS
import hr.dsokac.androidcommons.permissions.LOCATION_PERMISSIONS
import hr.dsokac.androidcommons.permissions.callbacks.PermissionCallback
import hr.dsokac.androidcommons.test.extensions.setSDK
...
class ActivityPermissionManagerTest {
    @Mock
    ...
    fun setup() {
        ...
        permissionManager = ActivityPermissionManager(WeakReference(activity))
    }
    ...
    fun allowedPermissionsPreM() {
        ...
        verify(activity).onRequestPermissionsResult(requestCode, requestedPermissions, grantResults)
        Assertions.assertTrue(allowed.get())
        Assertions.assertFalse(disallowed.get())
    }
}